...
# compoundAPart1text = basicFont.render(compoundAPart1,True,WHITE,BLUE)
compoundAPart1text = basicFont.render(compoundAPart1,True,BLACK,WHITE)
# compoundAPart2text = basicFont.render(compoundAPart2,True,RED,GRAY)
compoundAPart2text = basicFont.render(compoundAPart2,True,RED,WHITE)
...
compoundBPart2text = basicFont.render(compoundBPart2,True,RED,WHITE)
