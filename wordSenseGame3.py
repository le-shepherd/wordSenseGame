...
########################################################
#
#    Version targeting the first and second part of the compound (including five mixed items)
#
########################################################
...
# Note: below the highlighting of parts is switched off, making it all a tiny bit more difficult. (Also, programming the highlighting for this mixed version would have been quite a bit of additional work ;))

compoundAPart1text = basicFont.render(compoundAPart1,True,BLACK,WHITE)
...
compoundBPart1text = basicFont.render(compoundBPart1,True,BLACK,WHITE)
